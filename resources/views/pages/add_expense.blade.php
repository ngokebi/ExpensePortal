                    ...
                    <div class="white_box mb_30">
                        ...
                        <form action="{{ route('expense.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="Date_Issue" name="Date_Issue">
                            </div>
                            @error('Date_Issue')
                                <span class="text-danger"> {{ $message }}</span>
                            @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="Comment" cols="10" rows="10" placeholder="Comment"></textarea>
                            </div>
                            @error('Comment')
                                <span class="text-danger"> {{ $message }}</span>
                            @enderror
                            <div class="mb-3">
                                <img src="{{ !empty($expense->Receipt) ? url('upload/images/' . $expense->Receipt) : url('upload/upload.png') }}"
                            ...
                            <button type="submit" class="btn btn-rounded btn-outline btn-secondary"
                                style="float: right; margin-right:2%;">Add Expense</button>
                        </form>
                    </div>
                </div>
